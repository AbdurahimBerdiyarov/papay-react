...
export function Events() {
  const events_list = [
    ...
    {
      title: "Hali his qilmagan hisni his qilmoqchimiz?",
      desc: "Marhaba promokodi orqali 50% skidkani qolga kiriting ",
        ...
        <Stack className="events_main">
          ...
          <Box className={"prev_next_frame"}>
            <img
              ...
              className={"swiper-button-prew"}
            />
            <div className={"dot_frame_pagination swiper-pagination"}></div>
            <img
              src={"/icons/arrow-right.svg"}
              className={"swiper-button-text"}
